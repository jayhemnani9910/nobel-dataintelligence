...
from src.models.cnn import MultiScaleSpectralCNN, ResidualBlock1D, SpectralCNN
...
class TestSpectralCNN(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.model = SpectralCNN(
            input_channels=1, hidden_channels=32, output_dim=128, dropout=0.1
        ).to(self.device)
...
class TestModelOutputShapes(unittest.TestCase):
    ...
    def test_multimodal_output_shapes(self):
        ...
        model = VibroStructuralModel(
            latent_dim=128, gnn_input_dim=24, fusion_type="bilinear", num_go_terms=50
        )
